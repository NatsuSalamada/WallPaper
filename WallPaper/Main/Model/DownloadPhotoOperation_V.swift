//
//  DownloadPhotoOperation_V.swift
//  WallPaper
//
...
protocol DownloadPhotoOperation_VDelegate:class {
...
class DownloadPhotoOperation_V:Operation,URLSessionDelegate,URLSessionDownloadDelegate {
    ...
    weak var delegate:DownloadPhotoOperation_VDelegate?
    
    init(indexPath:IndexPath, photoURL:String,needPercent:Bool, delegate:DownloadPhotoOperation_VDelegate?) {
