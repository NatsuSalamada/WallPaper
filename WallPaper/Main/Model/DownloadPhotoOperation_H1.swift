//
//  DownloadPhotoOperation_H1.swift
//  WallPaper
//
//  Created by Bé Nhện Của Bé Thảo on 17/08/2018.
//  Copyright © 2018 NatsuSalamada. All rights reserved.
//

import Foundation
import UIKit
protocol DownloadPhotoOperation_H1Delegate:class {
...
class DownloadPhotoOperation_H1:Operation,URLSessionDelegate,URLSessionDownloadDelegate {
    ...
    weak var delegate:DownloadPhotoOperation_H1Delegate?
    
    init(indexPath:IndexPath, photoURL:String,needPercent:Bool, delegate:DownloadPhotoOperation_H1Delegate?) {
