//
//  Click_LivePhotoCollectionViewCell.swift
//  WallPaper
//
...
//        if documentsURL.fileExists(atPath: manager.appendingPathComponent("\(imagedTemp)IMG.MOV").path) && documentsURL.fileExists(atPath: manager.appendingPathComponent("\(imagedTemp)IMG.JPG").path){
//
//        }
//        let livePT:PHLivePhotoView = PHLivePhotoView()
//        PHLivePhoto.request(withResourceFileURLs: [ manager.appendingPathComponent("\(imagedTemp)IMG.MOV"), manager.appendingPathComponent("\(imagedTemp)IMG.JPG")],
//                            placeholderImage: nil,
