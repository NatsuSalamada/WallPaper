...
class CollViewCell1: UICollectionViewCell,UIImagePickerControllerDelegate {
    
    @IBOutlet weak var view: UIView!
    
    
    @IBOutlet weak var LivePhotoCate: UIImageView!
    ...
    func setupPercentageLabel() {
        ...
        percentageLabel.frame = CGRect(x: 0, y: 0, width: 30, height: 30)
